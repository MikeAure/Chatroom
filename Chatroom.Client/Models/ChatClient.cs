...
namespace Chatroom.Client.Models
{
    public class ChatClient : IChat
    {
        ...
        public BindingList<Chatroom.Client.Models.Client> ClientList { get; set; }
        ...
        public void StartConnection()
        {
            ...
            this.Task = Task.Run(() =>ReceiveMessages(CancellationTokenSource.Token));
                ...
                try
                {
                    ...
                    if (x > 0)
                    {
                        ...
                        if (strMessage.Substring(0, 8) == "/setname")
                        {
                            ...
                            this.Dispatcher.Invoke(new Action(() =>
                            {
                                this.ClientList.Add(new Chatroom.Client.Models.Client() { ID = ClientIdCounter, Username = newUsername });
                            }));
