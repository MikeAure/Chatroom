...
namespace Chatroom.Client.ViewModels
{
     public class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        private Chatroom.Client.Models.Client selectedUsername;
        ...
        public BindingList<Chatroom.Client.Models.Client> ClientList
        {
            get
            {
        ...
        public Chatroom.Client.Models.Client SelectedUsername
        {
            get
            {
            ...
            set
            {
                ...
                if (this.selectedUsername is Chatroom.Client.Models.Client)
                {
        ...
        private void SelectClient()
        {
            ...
            this.ClientList = new BindingList<Chatroom.Client.Models.Client>();
        ...
        public void SendMessage(string targetUsername, string messageContent)
        {
            ...
            else
            {
                ...
                if (this.IsServer)
                {
                    Chatroom.Client.Models.Client client = this.chatInterface.ClientList.FirstOrDefault(i => i.Username == this.TargetUsername);
                    if (client != null)
                    {
