...
namespace Chatroom.Server.Models
{
    public class ChatServer : IChat
    {
        ...
        public void OnNewConnection(EventArgs name)
        {
            this.NewConnection?.Invoke(this, name);
        }
        public ChatServer()
        {
        ...
        private void AddToChatuserList(object sender, EventArgs e)
        {
            Client client = new Client(e.ToString());
        ...
        public void StartConnection()
        {
            ...
            this.Task = Task.Run(() => WaitForConnections(CancellationTokenSource.Token));
            ...
            this.NewConnection += AddToChatuserList;
        }

        private void WaitForConnections(CancellationToken cancellationToken)
        {
            while (true && !cancellationToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    client.Task = Task.Run(()=>ProcessMessages(client, cancellationToken));
        ...
        private void ProcessMessages(Client client, CancellationToken cancellationToken)
        {
            while (true&&!cancellationToken.IsCancellationRequested)
            {
                try
